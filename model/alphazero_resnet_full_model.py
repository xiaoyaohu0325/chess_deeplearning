from model.alphazero_resnet_model import *


class AlphaZeroResNetFULL(AlphaZeroResNet):
    ...
    def _tower_loss(self, scope, image_batch, label_batch, z_batch, tower_idx):
        ...
        with tf.variable_scope('res_block_0'):
            ...
            tf.logging.info('Residual block 0 {0}'.format(x.get_shape()))
        ...
        for i in range(1, self.hps.num_residual_units):
            with tf.variable_scope('res_block_%d' % i):
                ...
                tf.logging.info('Residual block {0} {1}'.format(i, x.get_shape()))
        ...
        with tf.variable_scope('policy_head'):
            ...
            tf.logging.info('Policy head {0}'.format(logits.get_shape()))
        ...
        with tf.variable_scope('value_head'):
            ...
            tf.logging.info('Value head {0}'.format(value.get_shape()))
        ...
        with tf.variable_scope('result_acc'):
            ...
            tf.summary.scalar('result_accuracy_tower_{}'.format(tower_idx), result_acc)
